...
tool_info = server_login_INFO  # 工具信息
...
@bp.route(f"/{tool_name}/", methods=["GET", "POST"])
def index():
...
def server_login_exec(target_file_path="", plugins="", output_file_path=""):
    shell = ""
