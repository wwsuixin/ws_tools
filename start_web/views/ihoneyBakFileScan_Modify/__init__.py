...
tool_info = ihoneyBakFileScan_Modify_INFO  # 工具信息
...
def update():
    ...
    res["data"] = ihoneyBakFileScan_Modify_exec(
...
def ihoneyBakFileScan_Modify_exec(target_file_path="", plugins="", output_file_path=""):
    shell = ""
