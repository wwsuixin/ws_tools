...
def index():
    ...
    return render_template(
        ...
        res=dict(
            ...
            shell=wxapp_exec(target_file_path=target_document,output_file_path=output_file_path),
        ),
    )
...
def update():
    ...
    res["data"] = wxapp_exec(
        target_file_path=targets, output_file_path=output_file_path
    )
    return res


def wxapp_exec(target_file_path="", plugins="", output_file_path=""):
    shell = ""
